...
//Accessing Edit from View List generated by shortcode manually placed on a manually created page  
 if(baseURLEntry.indexOf("http://34.195.47.189/create-form-step-1-view/entry") > -1){
...
$j("#input_1_2").val("http://34.195.47.189/create-form-step-2/");//Create form page for step 2
var routelink = $j("#input_1_2").val();
     localStorage.setItem("Form1_Update", routelink);
}
  });
...
var baseURLEntry = location.protocol + '//' + location.host + location.pathname;
//Accessing Edit from View List generated by shortcode manually placed on a manually created page  
 if(baseURLEntry.indexOf("http://34.195.47.189/create-form-step-2-view/entry") > -1){
  $j(document).ready(function() {
...
if(baseURLEntry.indexOf("http://34.195.47.189/view/dummyorgliststep1/entry") > -1){
$j(document).ready(function() {
$j("#gform_1").submit(function() { 
if($j("#input_1_2").val()){
var routelink = $j("#input_1_2").val();
