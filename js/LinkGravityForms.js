...
sig = CalculateSig(stringToSign, privateKey);
var get_url6 = 'http://52.87.218.201/gravityformsapi/entries/' + $j("#input_11_9").val() + '?api_key=' + publicKey + '&signature=' + sig + '&expires=' + future_unixtime;
...
$j("#anchorBI").attr("href", "http://52.87.218.201/capture-insights-business-insights/?company_name=" + entry1['1']  + "&step1_entry_id=" + entry1['id'] + "&step3_entry_id=" + entry1['12'] + "&mvc_entry_id=" + entry1['13'] + '&empathy_entry_id='+ entry1['14'] + '&bi_entry_id='+ entry1['18'] + '&cs_entry_id='+ entry1['16'] + '&isCompleted=' + entry1["10"]);

$j("#anchorCS").attr("href", "http://52.87.218.201/capture-insights-create-solutions/?company_name=" + entry1['1']  + "&step1_entry_id=" + entry1['id'] + "&step3_entry_id=" + entry1['12'] + "&mvc_entry_id=" + entry1['13'] + '&empathy_entry_id='+ entry1['14'] + '&bi_entry_id='+ entry1['18'] + '&cs_entry_id='+ entry1['16'] + '&isCompleted=' + entry1["10"]);

$j("#anchorFS").attr("href", "http://52.87.218.201/finish-submit/?company_name=" + entry1['1']  + "&step1_entry_id=" + entry1['id'] + "&step3_entry_id=" + entry1['12'] + "&mvc_entry_id=" + entry1['13'] + '&empathy_entry_id='+ entry1['14'] + '&bi_entry_id='+ entry1['18'] + '&cs_entry_id='+ entry1['16'] + '&isCompleted=' + entry1["10"]);

        break;
    case "bi":

$j("#anchorEE").attr("href", "http://52.87.218.201/capture-insights-establish-empathy/?company_name=" + entry1['1']  + "&step1_entry_id=" + entry1['id'] + "&step3_entry_id=" + entry1['12'] + "&mvc_entry_id=" + entry1['13'] + '&empathy_entry_id='+ entry1['14'] + '&bi_entry_id='+ entry1['18'] + '&cs_entry_id='+ entry1['16'] + '&isCompleted=' + entry1["10"]);
...
$j("#anchorBI").attr("href", "http://52.87.218.201/capture-insights-establish-empathy/?company_name=" + entry1['1']  + "&step1_entry_id=" + entry1['id'] + "&step3_entry_id=" + entry1['12'] + "&mvc_entry_id=" + entry1['13'] + '&empathy_entry_id='+ entry1['14'] + '&bi_entry_id='+ entry1['18'] + '&cs_entry_id='+ entry1['16'] + '&isCompleted=' + entry1["10"]);
...
$j("#anchorCS").attr("href","http://52.87.218.201/capture-insights-create-solutions/?company_name=" + qs["company_name"] + '&step1_entry_id=' + qs["step1_entry_id"] + '&step3_entry_id=' + qs["step3_entry_id"] + '&mvc_entry_id=' + qs["mvc_entry_id"] + '&empathy_entry_id=' + qs["empathy_entry_id"]  + '&bi_entry_id='+ qs["bi_entry_id"] + '&cs_entry_id='+ qs["cs_entry_id"]);

$j("#anchorFS").attr("href", "http://52.87.218.201/finish-submit/?company_name=" + qs["company_name"] + '&step1_entry_id=' + qs["step1_entry_id"] + '&step3_entry_id=' + qs["step3_entry_id"] + '&mvc_entry_id=' + qs["mvc_entry_id"] + '&empathy_entry_id=' + qs["empathy_entry_id"]  + '&bi_entry_id='+ qs["bi_entry_id"] + '&cs_entry_id='+ qs["cs_entry_id"]);
if ($j(".display-name")[0]){
...
$j("#anchorFS").attr("href", "http://52.87.218.201/finish-submit/" + routeparams);// "http://52.87.218.201/finish-submit/?company_name=" + qs["company_name"] + '&step1_entry_id=' + qs["step1_entry_id"] + '&step3_entry_id=' + qs["step3_entry_id"] + '&mvc_entry_id=' + qs["mvc_entry_id"] + '&empathy_entry_id=' + qs["empathy_entry_id"]  + '&bi_entry_id='+ qs["bi_entry_id"] + '&cs_entry_id='+ qs["cs_entry_id"]);
...
if(errorOccured == "proceed"){
    ...
    entry3['4'] = hq;
		...
		orgspan.onclick = function() {
            ...
            error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' Step 2 Update Org');}
        });
}
...
//$j('<form action="http://52.87.218.201/organizational-profile/" method="post"><button style="width:200px" class="sticky-list-edit submit prevnextbtn">< Back</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+step1_entry_id+'"></form>').insertBefore('#anchorNextStep');
...
$j('<form action="http://52.87.218.201/create-map-value-chain/" method="post"><button style="margin-left:50%" class="sticky-list-edit submit main">EDIT VALUE CHAIN MAPPING DATA</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+mvc_entry_id+'"></form>').insertBefore('#footer');//.insertBefore('#myLoginModal');
        ...
        $j.ajax({
            ...
            data: entry_json,
            contentType:'application/json',
            success: function(result) {console.log('success - updating step 1 with step 3 entry ID and setting profile COMPLETE');},
            error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' Map Value Chain: tryin to update step 1 with step 3 entry ID');}
        });
...
if(baseURLEntry.indexOf("http://52.87.218.201/create-map-value-chain/") > -1){
...
$j.ajax({
    ...
    type: 'DELETE',
    contentType:'application/json',
    success: function(result) {console.log('value chain dup sticky list entry deleted');},
    error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' sticky list delete for VALUE CHAIN entry');}
});
...
//$j('<form action="http://52.87.218.201/establish-empathy-form/" method="post"><button style="width:200px" class="sticky-list-edit submit main">EDIT EMPATHY DATA</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+empathy_entry_id+'"></form>').insertBefore('#placeholder');
$j('<table id="btnEmpathyContainer" style="margin-left:25%;visibility:visible;width:700px"><tr style="background-color:white"><td style="width:10px;padding:10px"><a id="anchorPrevious" href="">PREVIOUS ACTIVITY</a></td><td style="width:5px;padding:5px"><form action="http://52.87.218.201/establish-empathy-form/" method="post"><button style="float:none" class="sticky-list-edit submit main">EDIT EMPATHY DATA</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+empathy_entry_id+'"></form></td><td style="width:5px;padding:5px"><a id="anchorNext" href="" >NEXT ACTIVITY</a></td></tr></table>').insertBefore('#placeholder');
...
entry2['20'] = d.toDateString();
        ...
        $j.ajax({
            ...
            data: entry_json,
            contentType:'application/json',
            success: function(result) {console.log('success - update step 1 form with VALUE CHAIN entry ID');},
            error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' Establish Empathy: trying to update step 1 with VALUE CHAIN entry ID');}
        });
//}
...
$j.ajax({
    ...
    type: 'DELETE',
    contentType:'application/json',
    success: function(result) {console.log('dup sticky list empathy entry deleted');},
    error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' empathy entry sticky list delete');}
});
...
//$j('<form action="http://52.87.218.201/business-insights-form/" method="post"><button style="width:200px" class="sticky-list-edit submit main">EDIT BUSINESS INSIGHT DATA</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+bi_entry_id+'"></form>').insertBefore('#placeholder');
$j('<table id="btnBIContainer" style="margin-left:25%;visibility:visible;width:700px"><tr style="background-color:white"><td style="width:10px;padding:10px"><a id="anchorPrevious" href="">PREVIOUS ACTIVITY</a></td><td style="width:5px;padding:5px"><form action="http://52.87.218.201/business-insights-form/" method="post"><button style="float:none" class="sticky-list-edit submit main">EDIT BUSINESS INSIGHTS DATA</button><input type="hidden" name="mode" value="edit"><input type="hidden" name="edit_id" value="'+bi_entry_id+'"></form></td><td style="width:5px;padding:5px"><a id="anchorNext" href="" >NEXT ACTIVITY</a></td></tr></table>').insertBefore('#placeholder');
...
entry3['20'] = d.toDateString();
        ...
        $j.ajax({
            ...
            data: entry_json,
            contentType:'application/json',
            success: function(result) {console.log('success - adding empathy entry id to step 1');},
            error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' Business Insights - updating step 1 with empathy entry ID');}
        });
//}
});
...
$j.ajax({
    ...
    type: 'DELETE',
    contentType:'application/json',
    success: function(result) {console.log('dup sticky list  business insights entry deleted');},
    error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' business insights sticky list delete');}
});
...
entry3['20'] = d.toDateString();
        ...
        $j.ajax({
            ...
            data: entry_json,
            contentType:'application/json',
            success: function(result) {console.log('success - updated step 1 with business insights entry id');},
            error: function(result, textStatus, errorThrown){console.log('error ' + errorThrown + ' Create Solutions - updating step 1 with business insights entry id');}
        });
//}
});
